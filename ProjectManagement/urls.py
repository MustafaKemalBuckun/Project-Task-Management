...
urlpatterns = [
    ...
    # path('accept_invitation/<int:company_id>/', main_views.accept_company_invitation, name='accept_company_invitation'),
    # path('decline_invitation/<int:company_id>/', main_views.decline_company_invitation, name='decline_company_invitation'),
    path('leave_company/<int:company_id>/', main_views.leave_company, name='leave_company'),
    path('companies/<int:company_id>/', main_views.company_view, name='company'),
